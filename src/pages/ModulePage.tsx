...
type ModulePageProps = {
  title: string;
  description: string;
  module: Exclude<AdminModule['module'], 'config' | 'ai-costs'>;
};
...
const moduleLoaders: Record<Exclude<AdminModule['module'], 'config' | 'ai-costs'>, () => Promise<unknown>> = {
  dashboard: async () => {
  ...
  moderation: () => apiClient.getModerationItems(),
};
