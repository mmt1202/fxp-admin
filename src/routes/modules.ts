...
export const adminModules: AdminModule[] = [
  module({ path: '/dashboard', label: '数据看板', icon: '📊', module: 'dashboard', description: '核心指标与增长趋势概览。', permission: 'dashboard:view', endpoints: [{ method: 'GET', path: '/admin/dashboard', description: '获取后台数据看板核心指标。' }, { method: 'GET', path: '/admin/dashboard/trend', description: '获取后台数据看板趋势数据。' }, { method: 'GET', path: '/admin/search?q=关键词', description: '后台全局搜索用户、订单、房源、小区、举报和反馈。' }] }),
