export type AdminModule = {
  ...
  icon: string;
  description: string;
  module: 'dashboard' | 'users' | 'orders' | 'ai-stats' | 'community-reports' | 'user-lifecycle' | 'config';
};
...
export const adminModules: AdminModule[] = [
  ...
  { path: '/properties', label: '房源管理', icon: '🏠', description: '维护房源基础信息、上下架状态、区域与配套标签。', module: 'dashboard' },
