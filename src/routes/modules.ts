export type AdminModule = {
  ...
  icon: string;
  description: string;
  module: 'dashboard' | 'users' | 'properties' | 'reviews' | 'moderation' | 'config' | 'ai-prompts';
};
...
export const adminModules: AdminModule[] = [
  ...
  { path: '/ai/prompts', label: 'AI Prompt 管理', icon: '🤖', description: '管理 AI 评房 Prompt 模板、发布版本、回滚记录与版本对比。', module: 'ai-prompts' },
