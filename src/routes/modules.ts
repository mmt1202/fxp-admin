export type AdminModule = {
  ...
  page?: 'system-config' | 'risk-watchlist';
};
...
export const adminModules: AdminModule[] = [
  ...
  { path: '/security/watchlist', label: '观察名单', icon: '🚨', description: '维护高风险用户观察名单，查看命中行为与风险事件时间线。', page: 'risk-watchlist' },
  { path: '/config', label: '系统配置', icon: '⚙️', description: '管理 App 公告、业务开关、最低版本与强制更新策略。', page: 'system-config' },
];
