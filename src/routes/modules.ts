export type AdminModule = {
  ...
  icon: string;
  description: string;
  module: 'dashboard' | 'users' | 'properties' | 'communities' | 'reviews' | 'moderation' | 'config';
};
...
export const adminModules: AdminModule[] = [
  ...
  { path: '/properties', label: '房源管理', icon: '🏠', description: '维护房源基础信息、上下架状态、区域与配套标签，创建房源时可关联小区库。', module: 'properties' },
  { path: '/communities', label: '小区库管理', icon: '🏘️', description: '维护小区基础数据、标签、风险提示，并支持重复小区合并。', module: 'communities' },
