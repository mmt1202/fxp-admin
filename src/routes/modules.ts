export type AdminModule = {
  ...
  icon: string;
  description: string;
  module: 'dashboard' | 'users' | 'properties' | 'reviews' | 'moderation' | 'config' | 'ai-costs';
};
...
export const adminModules: AdminModule[] = [
  ...
  { path: '/ai-costs', label: 'AI 成本监控', icon: '🤖', description: '跟踪 AI 调用成本、Token 消耗、模型分布与高成本用户排行。', module: 'ai-costs' },
