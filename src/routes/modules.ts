export type AdminModule = {
  ...
  icon: string;
  description: string;
  module: 'dashboard' | 'users' | 'properties' | 'reviews' | 'moderation' | 'config' | 'login-security';
};
...
export const adminModules: AdminModule[] = [
  ...
  { path: '/login-security', label: '登录安全', icon: '🔐', description: '监控登录日志、风险登录事件与账号风控处置。', module: 'login-security' },
