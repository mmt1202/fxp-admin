export type AdminModuleKey = 'dashboard' | 'users' | 'properties' | 'reviews' | 'moderation' | 'support-tickets' | 'config';
...
export const adminModules: AdminModule[] = [
  ...
  { path: '/support/tickets', label: '客服工单', icon: '🎧', description: '集中处理用户咨询、投诉反馈、内部备注与客服转派。', module: 'support-tickets' },
